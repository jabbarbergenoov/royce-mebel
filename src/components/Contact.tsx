...
export function Contact() {
  const contactInfo = [
    { icon: Phone, text: "+7 (495) 123-45-67", label: "Телефон" },
    { icon: Mail, text: "info@furniture.ru", label: "Email" },
    { icon: MapPin, text: "Москва, ул. Примерная, д. 123", label: "Адрес" }
  ];
          ...
          >
            <form className="space-y-4">
              <input
                ...
                className="w-full px-6 py-4 rounded-xl outline-none transition-all focus:ring-2"
                style={{
              ...
              <textarea
                ...
                rows={5}
                className="w-full px-6 py-4 rounded-xl outline-none transition-all focus:ring-2 resize-none"
                style={{
                  backgroundColor: '#E1C78F',
                  color: '#706233',
                  border: 'none'
