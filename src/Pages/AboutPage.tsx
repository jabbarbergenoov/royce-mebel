...
export function AboutPage() {
  const values = [
    ...
    },
    {
      icon: Users,
      title: "Команда",
      description: "У нас есть профессионали: дизайнеры, мастера, технологи — все влюблены в своё дело и работают для вас."
    }
  ];

  const timeline = [
    { year: "1998", event: "Основание компании", description: "Начало пути с небольшой мастерской" },
    { year: "2002", event: "Офицально открылись", description: "Создали первие пройзвадстви" },
    { year: "2010", event: "Расширение производства", description: "Открытие собственной фабрики" },
    { year: "2015", event: "Первый пройзводство", description: "Первыйе пройзводстви каторый сделан от нас" },
    { year: "2020", event: "Новый веши", description: "Получили новый примишестви" },
